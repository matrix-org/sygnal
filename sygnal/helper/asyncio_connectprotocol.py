...
class HttpConnectProtocol(asyncio.Protocol):
    ...
    """
    def __init__(self, proxy_address: str, target_address: str, protocol_on_top: asyncio.Protocol,
    ...
    def connection_made(self, transport: Transport) -> None:
        ...
        if self.basic_proxy_auth is not None:
            ...
            transport.write(f"Proxy-Authorization: basic {encoded_credentials}\r\n".encode())
